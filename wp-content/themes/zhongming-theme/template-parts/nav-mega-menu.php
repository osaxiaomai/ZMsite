    ...
    <div class="mega-inner">
        ...
        <div class="mega-col">
            ...
            <a href="<?php echo zm_category_link('standard-indoor'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/indoor.jpg" alt=""></div>
            ...
            <a href="<?php echo zm_category_link('cob-series'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/cob.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('169-indoor'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/169.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('indoor-rental'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/rental.jpg" alt=""></div>
                <div class="mega-content">
        ...
        <div class="mega-col">
            ...
            <a href="<?php echo zm_category_link('standard-outdoor'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/outdoor.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('panel-series'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/panel.jpg" alt=""></div>
                <div class="mega-content">
        ...
        <div class="mega-col">
            ...
            <a href="<?php echo zm_category_link('transparent-screen'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/transparent.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('film-screen'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/film.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('floor-tile-screen'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/floor.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('flexible-led'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/flexible.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('customized-xr'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/custom.jpg" alt=""></div>
                <div class="mega-content">
            ...
            <a href="<?php echo zm_category_link('photoelectric-glass'); ?>" class="mega-item">
                <div class="mega-icon"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/nav/glass.jpg" alt=""></div>
                <div class="mega-content">
